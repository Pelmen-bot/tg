...
def send_welcome(message):
    bot.reply_to(message,"Мои команды на данный момент start, gif, mem, animal, trash, trash_meme" )
...
def send_welcome(message):
    trash = [
    "ежегодно человек выбрасывает около 2 тоннн мусора.",
    ...
    "В Тихом океане есть мусорное пятно, площадь которого достигает 1,5 млн км², что больше площади большинства стран мира.",
    "Половина населения Земли пьёт воду, загрязнённую в той или иной степени, а потому небезопасную для здоровья."
    ]
